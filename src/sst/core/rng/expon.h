...
public:
    ...
    */
    SSTExponentialDistribution(const double mn) : SSTRandomDistribution() {
    ...
    */
    SSTExponentialDistribution(const double mn, SST::RNG::Random* baseDist) : SSTRandomDistribution() {
