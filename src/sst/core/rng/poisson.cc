...
SSTPoissonDistribution::SSTPoissonDistribution(const double mn) : SSTRandomDistribution(), lambda(mn) {
...
double
SSTPoissonDistribution::getNextDouble() {
...
double
SSTPoissonDistribution::getLambda() {
    return lambda;
}
